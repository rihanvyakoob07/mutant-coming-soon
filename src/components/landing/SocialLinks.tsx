...
//   const socialLinks = [
//     { icon: <FaFacebookF className="text-white text-base lg:text-lg" />, href: '#', name: 'Facebook' },
//     { icon: <FaInstagram className="text-white text-base lg:text-lg" />, href: '#', name: 'Instagram' },
//     { icon: <FaLinkedinIn className="text-white text-base lg:text-lg" />, href: '#', name: 'LinkedIn' },
//     { icon: <FaYoutube className="text-white text-base lg:text-lg" />, href: '#', name: 'YouTube' },
//   ];
...
//             className="w-9 h-9 lg:w-10 lg:h-10 bg-[#4A4A4A] rounded-lg flex items-center justify-center hover:bg-[#5A5A5A] transition-colors duration-300 focus:outline-none"
